...
FEATURE_DIM = int(os.environ.get("COAD_FEATURE_DIM", "512"))   # CLIP ViT-B/32 default
...
FEATURES_DIR = Path(os.environ.get("COAD_FEATURES_DIR", DATA_DIR / "features")).expanduser()
