...
# ── Backbone / feature 설정 ───────────────────────────────────────────────────
# 백본을 바꾸려면 아래 두 값(또는 동명 환경변수)만 수정하면 됩니다.
#   CLIP ViT-B/32 : FEATURE_DIM=512, FEAT_ROOT=data/features
#   OpenCLIP L/14 : FEATURE_DIM=768, FEAT_ROOT=data/features_openclip_l14
FEATURE_DIM  = int(os.environ.get("COAD_FEATURE_DIM", "512"))
FEAT_ROOT    = Path(os.environ.get("COAD_FEATURES_DIR", "data/features"))
TRAIN_FEAT_DIR = FEAT_ROOT / "train"
VAL_FEAT_DIR   = FEAT_ROOT / "val"
